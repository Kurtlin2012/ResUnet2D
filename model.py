...
def ResUnet2D(input_size, init_filters=16, n_classes=2):
    ...
    dec4 = decoder(dec4, init_filters*8, enc4) # 64x64x128
    ...
    dec3 = decoder(dec3, init_filters*4, enc3) # 128x128x64
    ...
    dec2 = decoder(dec2, init_filters*2, enc2) # 256x256x32
    ...
    dec1 = decoder(dec1, init_filters, enc1) # 512x512x16
